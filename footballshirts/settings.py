...
SECRET_KEY = 'django-insecure-$@s@*f^b=el4z!55-d!mpujpa+b&-2s-3v5bvifmnb98r4ezfz'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'templates', 'allauth'),  # Directory for custom templates
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
